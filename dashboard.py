...
class IMS:
    ...
    def __init__(self, root):
        ...
        btn_exit=Button(LeftMenu,text="Salir",command=self.exit,image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("calisto mt",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
