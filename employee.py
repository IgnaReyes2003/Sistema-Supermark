...
class employeeClass:
    def __init__(self, root):
        ...
        #===== Opciones =====
        cmb_search=ttk.Combobox(SearchFrame,values=("Seleccione","Email","Nombre","Contacto"),state="readonly",justify=CENTER,font=("time new roman",15))
        cmb_search.place(x=10,y=10,width=180)
        cmb_search.current(0)

        txt_search=Entry(SearchFrame,font=("times new roman",15),bg="lightyellow").place(x=200,y=10)
